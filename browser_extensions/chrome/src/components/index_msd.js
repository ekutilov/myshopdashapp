...
async function loadFonts() {
  const webFontLoader = await __vitePreload(() => Promise.resolve().then(() => webfontloader$1), true ? void 0 : void 0);
  webFontLoader.load({
    google: {
...
(function(module) {
  (function() {
          ...
          for (h2 = 0; h2 < c.length; h2++) {
            ...
            if (null === X)
              if (window.FontFace) {
                ...
                X = false;
            X ? r = new P(p2(b.g, b), p2(b.h, b), b.c, k, b.s, n) : r = new Q(p2(b.g, b), p2(b.h, b), b.c, k, b.s, a2, n);
            l.push(r);
          }
          for (h2 = 0; h2 < l.length; h2++)
            l[h2].start();
        }
      }, 0);
    }
    ...
    ra.prototype.load = function(a) {
      function b() {
        if (f["__mti_fntLst" + d]) {
          var c2 = f["__mti_fntLst" + d](), e2 = [], h2;
          if (c2)
            for (var l = 0; l < c2.length; l++) {
              var k = c2[l].fontfamily;
              void 0 != c2[l].fontStyle && void 0 != c2[l].fontWeight ? (h2 = c2[l].fontStyle + c2[l].fontWeight, e2.push(new G(k, h2))) : e2.push(new G(k));
            }
          a(e2);
        } else
          setTimeout(function() {
    ...
    sa.prototype.load = function(a) {
      ...
      for (c = e.length; b < c; b++)
        if (d = e[b].split(":"), d[1])
          for (var h2 = d[1].split(","), l = 0; l < h2.length; l += 1)
            m.push(new G(d[0], h2[l]));
        else
          m.push(new G(d[0]));
      E(g, function() {
        a(m, f);
    ...
    function Da(a) {
      for (var b = a.f.length, c = 0; c < b; c++) {
        ...
        if (2 <= d.length) {
          ...
          g = [];
          if (m)
            for (var m = m.split(","), h2 = m.length, l = 0; l < h2; l++) {
              var k;
              k = m[l];
              if (k.match(/^[\w-]+$/)) {
      ...
      b ? A(this.c, (this.a.api || "https://use.typekit.net") + "/" + b + ".js", function(b2) {
        if (b2)
          ...
          for (var e = [], f = 0; f < b2.length; f += 2)
            for (var g = b2[f], m = b2[f + 1], h2 = 0; h2 < m.length; h2++)
              e.push(new G(g, m[h2]));
          try {
    ...
    Ha.prototype.load = function(a) {
      ...
      b ? (c.__webfontfontdeckmodule__ || (c.__webfontfontdeckmodule__ = {}), c.__webfontfontdeckmodule__[b] = function(b2, c2) {
        for (var g = 0, m = c2.fonts.length; g < m; ++g) {
          var h2 = c2.fonts[g];
          d.a.push(new G(h2.name, ga("font-weight:" + h2.weight + ";font-style:" + h2.style)));
        }
        a(d.a);
